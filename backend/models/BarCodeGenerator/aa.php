...
//$d2=new DNS2DBarcode();
//$d2->save_path="images/";
//echo $d2->getBarcodePNGPath("dinesh", 'pdf417',2, 2, [0, 0, 0]);
//echo $d2->getBarcodePNGPath("dinesh", 'datamatrix',2, 2, [0, 0, 0]);
//echo $d2->getBarcodePNGPath("dinesh", 'qrcode',2, 2, [0, 0, 0]);
...
//echo "<br />";
?>
<img src="<?php echo $d1->getBarcodePNGPath("1234567", 'EAN13'); ?>" />
