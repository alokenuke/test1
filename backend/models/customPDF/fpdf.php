...
define('FPDF_FONTPATH', dirname(preg_replace('/\\\\/', '/', __FILE__)) . "/font/");
...
class FPDF {
    ...
    function Image($file, $x = null, $y = null, $w = 0, $h = 0, $type = '', $link = '') {
        ...
        //Change to not show image if height and width is 0;
        if ($w == 0 || $h == 0) {
            // Put image at 96 dpi
            //$w = -96;//Change to not show image if height and width is 0;
            //$h = -96;
            return;
        }
