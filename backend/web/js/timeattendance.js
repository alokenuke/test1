app.controller('TimeAttendance', ['$scope', 'rest', '$location', '$route','$routeParams', 'alertService', '$http', 'breadcrumbsService', 'page_dropdown', '$rootScope',
        ...
        breadcrumbsService.add("/#/timeattendance", "Tags");
...
app.controller('TimeAttendanceCreate', ['$scope', 'rest', '$location', '$route','$routeParams', 'alertService', '$http', 'breadcrumbsService', 'tooltip', '$modal', '$log', 'alertService',
        ...
        $scope.copyLastTag = function() {
            ...
            $http.post("/timeattendance/get-last-tag", {'search': {'project_id': $scope.tagDetails.project_id}}).success(function(data) {
                if(data>0) {
        ...
        $scope.createSimilarTagModal = function() {
            ...
            var modalInstance = $modal.open({
                templateUrl: '/templates/timeattendance/create_similar_tag.html',
        ...
        $scope.loadTagById = function(selectedItem) {
            ...
            $http.get("/timeattendance/"+selectedItem+"?expand=projectLevelObj,itemObj,processObj,userGroup,tagAssignmentObj").success(function(data) {
        ...
        $scope.saveTagDetails = function() {
            ...
            $http.post("/timeattendance/create-simple-tags",{'tagDetails': $scope.tagDetails}).success(function(data) {
...
app.controller('TimeAttendanceUpdate', ['$scope', 'rest', '$location', '$route','$routeParams', 'alertService', '$http', 'breadcrumbsService', 'tooltip', '$modal', '$log', 'alertService',
                function ($scope, rest, $location, $route, $routeParams, alertService, $http, breadcrumbsService, tooltip, $modal, $log, alertService) {
        ...
        breadcrumbsService.add("/#/", "Home");
        breadcrumbsService.add("/#/timeattendance", "Tags");
        breadcrumbsService.add("/#/timeattendance/update/"+$routeParams.id+"/"+$routeParams.project_id, "Update Tag");
        ...
        $scope.saveTagDetails = function() {
            ...
            $http.post("/timeattendance/updatesimpletags/"+$routeParams.id,{'tagDetails': $scope.tagDetails}).success(function(data) {
                alertService.clearAll();
                if(data=='Success') {
...
app.controller('TimeAttendanceView', ['$scope', 'rest', '$location', '$route','$routeParams', 'alertService', '$http', 'breadcrumbsService', 
        ...
        breadcrumbsService.add("/#/", "Home");
        breadcrumbsService.add("/#/timeattendance", "Tags");
        breadcrumbsService.add("/#/timeattendance", "Tag Analytics");
        ...
        $http.get("/timeattendance/"+$routeParams.id+"?expand=projectLevelObj,userGroup,processObj,itemObj,tagAssignmentObj,relatedTags").success(function(data) {
